...
class UpdateDialog(tkinter.Toplevel):
    def __init__(self, db, cursor):
        ...
        self.text = tkinter.Text(self.frame1, width=50, height=10)  # TODO
        ...
        self.button = tkinter.Button(self.frame2, text="确定", command=self.update)
    ...
    def update(self):
        ...
        for update_time in self.update_time_lst:
            ...
            if not data_lst:
                self.text.insert(tkinter.END, '{} {} 更新完成, 共{}条数据\n'.format(self._get_current_time_str(),
